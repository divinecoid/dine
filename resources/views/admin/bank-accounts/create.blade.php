...
@section('title', 'Tambah Rekening - DINE.CO.ID')
        ...
        <form action="{{ route('admin.bank-accounts.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="flex gap-4">
                        <label class="flex items-center">
                            <input type="radio" name="owner_type" value="brand" class="mr-2" onchange="toggleOwnerFields()" checked>
                            <span class="text-sm text-gray-700">Brand</span>
                        </label>
                        <label class="flex items-center">
                            <input type="radio" name="owner_type" value="store" class="mr-2" onchange="toggleOwnerFields()">
                ...
                <div>
                    ...
                    <input type="text" id="bank_code" name="bank_code" value="{{ old('bank_code') }}"
            ...
            <div class="flex justify-end space-x-4 mt-6">
                ...
                <button type="submit" class="px-6 py-2 bg-gray-900 text-white rounded-lg hover:bg-gray-800">Simpan</button>
            </div>
        </form>
    </div>
</div>
