    ...
    <div class="bg-[#161615] border border-[#3E3E3A] rounded-lg shadow p-6">
        <form action="{{ route('admin.bank-accounts.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="flex gap-4">
                        <label class="flex items-center">
                            <input type="radio" name="owner_type" value="brand" class="mr-2 text-[#F53003] focus:ring-[#F53003]/50" onchange="toggleOwnerFields()" checked>
                            <span class="text-sm text-[#EDEDEC]">Brand</span>
                        </label>
                        <label class="flex items-center">
                            <input type="radio" name="owner_type" value="store" class="mr-2 text-[#F53003] focus:ring-[#F53003]/50" onchange="toggleOwnerFields()">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="notes" name="notes" rows="3"
                        class="w-full px-4 py-2 border border-[#3E3E3A] rounded-lg focus:ring-2 focus:ring-[#F53003]/50 focus:border-[#F53003]/50">{{ old('notes') }}</textarea>
                </div>
            </div>
            ...
            <div class="flex justify-end space-x-4 mt-6">
                ...
                <button type="submit" class="px-6 py-2 bg-[#F53003] text-white rounded-lg hover:bg-[#d42800] transition-colors">Simpan</button>
            </div>
        </form>
    </div>
</div>
