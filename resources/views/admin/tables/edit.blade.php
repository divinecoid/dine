    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('admin.tables.update', $table) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="notes" name="notes" rows="3"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900">{{ old('notes', $table->notes) }}</textarea>
                </div>
                ...
                <div class="md:col-span-2">
                    <label class="flex items-center">
                        ...
                        <input type="checkbox" name="is_active" value="1" {{ old('is_active', $table->is_active ? '1' : '0') == '1' ? 'checked' : '' }}
            ...
            <div class="flex justify-end space-x-4 mt-6">
                ...
                <button type="submit" class="px-6 py-2 bg-gray-900 text-white rounded-lg hover:bg-gray-800">Update Meja</button>
            </div>
        </form>
    </div>
</div>
