    ...
    <div class="bg-[#161615] border border-[#3E3E3A] rounded-lg shadow p-6">
        <form action="{{ route('admin.users.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label for="password" class="block text-sm font-medium text-[#EDEDEC] mb-2">
                        Password <span class="text-[#F53003]">*</span>
                    </label>
                ...
                <div>
                    <label for="password_confirmation" class="block text-sm font-medium text-[#EDEDEC] mb-2">
                        Confirm Password <span class="text-[#F53003]">*</span>
                    </label>
            ...
            <div class="flex justify-end space-x-4 mt-6">
                ...
                <button type="submit" class="px-6 py-2 bg-[#F53003] text-white rounded-lg hover:bg-[#d42800] transition-colors">Create User</button>
            </div>
        </form>
    </div>
</div>
