...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Manage your brands</p>
        </div>
        <a href="{{ route('admin.brands.create') }}" class="inline-flex items-center px-4 py-2 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-colors">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form method="GET" action="{{ route('admin.brands.index') }}" class="flex flex-wrap gap-4">
            ...
            <!-- Status Filter -->
            <select name="status" class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex justify-end space-x-2">
                                    <a href="{{ route('admin.brands.edit', $brand) }}" class="text-gray-600 hover:text-gray-900">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center">
                                ...
                                <h3 class="mt-2 text-sm font-semibold text-gray-900">No brands found</h3>
            ...
            <div class="bg-white px-4 py-3 border-t border-gray-200 sm:px-6">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex space-x-2">
                        ...
                        @else
                            <a href="{{ $brands->previousPageUrl() }}" class="px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50">Previous</a>
                        @endif
                        ...
                        @foreach(range(1, min(5, $brands->lastPage())) as $page)
                            ...
                            @else
                                <a href="{{ $brands->url($page) }}" class="px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50">{{ $page }}</a>
                            @endif
                        @endforeach
                        
                        @if($brands->hasMorePages())
                            <a href="{{ $brands->nextPageUrl() }}" class="px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50">Next</a>
                        @else
