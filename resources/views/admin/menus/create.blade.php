...
@section('title', 'Create Menu - DINE.CO.ID')
    ...
    <div class="bg-[#161615] border border-[#3E3E3A] rounded-lg shadow p-6">
        <form action="{{ route('admin.menus.store') }}" method="POST">
            ...
            <div class="flex justify-end space-x-4 mt-6">
                ...
                <button type="submit" class="px-6 py-2 bg-[#F53003] text-white rounded-lg hover:bg-[#d42800] transition-colors">Create Menu</button>
            </div>
        </form>
    </div>
</div>
