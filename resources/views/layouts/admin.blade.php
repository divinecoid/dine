...
<body class="bg-gray-50">
    <div class="flex h-screen overflow-hidden">
        <!-- Sidebar -->
        <aside id="sidebar" class="sidebar-transition fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-200 transform -translate-x-full lg:translate-x-0 lg:static lg:inset-0 flex flex-col">
            <!-- Sidebar Header - Sticky -->
            <div class="flex items-center justify-between h-16 px-6 border-b border-gray-200 bg-white sticky top-0 z-10 flex-shrink-0">
            ...
            <div class="px-4 py-4 border-t border-gray-200 bg-white sticky bottom-0 flex-shrink-0">
                <div class="flex items-center mb-3">
                    ...
                    <div class="ml-3 flex-1">
                        ...
                        <p class="text-xs text-gray-400 capitalize">{{ auth()->user()->role === 'brand_owner' ? 'Pemilik Brand' : 'Store Manager' }}</p>
                    </div>
                </div>
